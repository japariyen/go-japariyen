...
//
// Detailed usage document and tutorial available on the go-japariyen Wiki page:
// https://github.com/japariyen/go-japariyen/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
