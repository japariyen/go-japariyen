...
import (
	...
	"github.com/japariyen/go-japariyen/internal/jsre"
	"github.com/japariyen/go-japariyen/internal/web3ext"
...
// Welcome show summary of current Gjpy instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gjpy metadata
	fmt.Fprintf(c.printer, "Welcome to the Gjpy JavaScript console!\n\n")
	c.jsre.Run(`
