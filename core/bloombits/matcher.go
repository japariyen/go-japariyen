...
// that address/topic, and binary AND-ing those vectors togjpyer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togjpyer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togjpyer with other sessions.
//
