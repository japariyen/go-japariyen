...
import (
	...
	"github.com/japariyen/go-japariyen/accounts/usbwallet"
...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of gjpy is "gjpy". If no
...
func makeAccountManager(conf *Config) (*accounts.Manager, string, error) {
	...
	if keydir == "" {
		// There is no datadir.
		keydir, err = ioutil.TempDir("", "go-japariyen-keystore")
		ephemeral = keydir
	}
