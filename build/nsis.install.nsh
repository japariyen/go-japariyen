Name "gjpy ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/japariyen/go-japariyen/issues"
!define UPDATEURL "https://github.com/japariyen/go-japariyen/releases"
!define ABOUTURL "https://github.com/japariyen/go-japariyen#ethereum-go"
...
# Install gjpy binary
Section "Gjpy" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gjpy}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gjpy.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gjpy.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gjpy incoming peers (TCP:11235)"
  SimpleFC::AdvRemoveRule "Gjpy outgoing peers (TCP:11235)"
  SimpleFC::AdvRemoveRule "Gjpy UDP discovery (UDP:11235)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gjpy incoming peers (TCP:11235)" ""  6 1 1 2147483647 1 "$INSTDIR\gjpy.exe" "" "" "Ethereum" 11235 "" "" ""
  SimpleFC::AdvAddRule "Gjpy outgoing peers (TCP:11235)" ""  6 2 1 2147483647 1 "$INSTDIR\gjpy.exe" "" "" "Ethereum" "" 11235 "" ""
  SimpleFC::AdvAddRule "Gjpy UDP discovery (UDP:11235)" "" 17 2 1 2147483647 1 "$INSTDIR\gjpy.exe" "" "" "Ethereum" "" 11235 "" ""
